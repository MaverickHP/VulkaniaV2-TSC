...
contract Vulkania is ERC20, Ownable {
	...
	CustomTaxPeriod private _eruption1 = CustomTaxPeriod('eruption1',0,3600,300,500,0,1500,0,1000,0,500);
	CustomTaxPeriod private _eruption2 = CustomTaxPeriod('eruption2',0,3600,150,500,300,1000,150,1000,500,500);
